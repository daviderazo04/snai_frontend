  ...
  <div class="page-container">
    <div class="page-header">
      <div class="title-wrap">
        <h2>G2</h2>
        <span class="subtitle">Administración de grupos G2</span>
      </div>
            ...
            <tr v-if="gdos.length === 0">
              <td colspan="3">
                <div class="empty">
                  ...
                  <span>No hay grupos G2 registrados.</span>
                </div>
              </td>
            </tr>
          </tbody>
...
const load = async () => {
  try {
    ...
    console.error("Error cargando G2:", error)
  }
}
...
// Agregué esta función para que el botón de editar funcione
const edit = (id) => {
  router.push(`/app/gdos/${id}`)
}
